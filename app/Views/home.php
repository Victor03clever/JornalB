                    ...
                    <div class="col-6">
                        <div class="mb-3 d-flex align-items-center">
                            ...
                            <div class="pl-3">
                                ...
                                <small class="text-muted">Fev 1 &middot; 5 min escrito</small>
                            </div>
                        </div>
                        <div class="mb-3 d-flex align-items-center">
                            ...
                            <div class="pl-3">
                                ...
                                <small class="text-muted">Fev 1 &middot; 8 min escrito</small>
                            </div>
                        </div>
                        <div class="mb-3 d-flex align-items-center">
                            ...
                            <div class="pl-3">
                                ...
                                <small class="text-muted">Fev 1 &middot; 20 min escrito</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="course-item">
                            <img src="assets/img/IMG-20221122-WA0011.jpg" class="img-fluid" alt="...">
                            <div class="course-content">
                                ...
                                <h3><a href="<?=URL?>/events">Alunos criam software de gestão escolar!!</a></h3>
                                <p>Alunos da 13ª estão capacitados para o mercado de emprego com as suas novas dinamicas!.</p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                        <div class="course-item">
                            <img src="assets/img/IMG-20221122-WA0035.jpg" class="img-fluid" alt="...">
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4>2º destaque</h4>
                                ...
                                <h3><a href="<?=URL?>/events">Aniversário da escola</a></h3>
                                <p>Haverá uma atividade no Betânia dia 08/03.</p>
                                <div class="trainer d-flex justify-content-between align-items-center">
                    ...
                    </div> <!-- fim item notícias -->

                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                        <div class="course-item">
                            <img src="assets/img/FB_IMG_16682529296599645.jpg" class="img-fluid" alt="...">
                            <div class="course-content">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4>3º destaque</h4>
                                ...
                                <h3><a href="<?=URL?>/events">Encarregados reclamam pelas notas dos seus filhos?</a></h3>
                                <p>Foram publicadas as pautas na escola e os encarregados de educação não se contentam com as notas dos seus filhos.</p>
                                <div class="trainer d-flex justify-content-between align-items-center">
