        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="<?=ucwords($url) == "Courses"? 'active': '' ?>" href="<?=URL?>/courses">Atividades Escolares</a></li>
                    <li><a class="<?=ucwords($url) == "Trainers"? 'active': '' ?>" href="<?=URL?>/trainers">Avisos</a></li>
                    <li><a class="<?=ucwords($url) == "Events"? 'active': '' ?>" href="<?=URL?>/events">Notícias</a></li>
                    <li><a class="<?=ucwords($url) == "Pricing"? 'active': '' ?>" href="<?=URL?>/pricing">Passatempo</a></li>
